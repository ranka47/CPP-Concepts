...
int main()
{
	...
	cout<<sizeof(base)<<sizeof(derived1)<<sizeof(derived2)<<sizeof(derived3)<<endl;
	cout<<sizeof(virtualBase)<<sizeof(derived4)<<sizeof(derived5)<<sizeof(derived6)<<endl;
	cout<<sizeof(staticBase)<<sizeof(staticDerived)<<endl;
	cout<<staticDerived::data;
	return 0;
}